<?php
// sections/achievements.php - PATCHED FOR PUBLIC VIEW (v2 - AJAX compatible)
...
// ============================================
?>
<section id="tab-achievements" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
