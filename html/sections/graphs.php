<?php
// sections/graphs.php - PATCHED FOR PUBLIC VIEW (v2 - AJAX compatible)
...
// ============================================
?>
<section id="tab-graphs" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
    ...
    <div class="muted" style="text-align: center; padding: 40px 0;">
        ...
        <div>Loading Timeline Graphs...</div>
    </div>
