<?php
// sections/professions.php - PATCHED FOR PUBLIC VIEW (v2 - AJAX compatible)
...
// ============================================
?>
<section id="tab-professions" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
    data-char-name="<?php echo $charName; ?>">

    <div class="muted" style="text-align: center; padding: 40px 0;">
        <div style="font-size: 2rem; margin-bottom: 16px;">🛠️</div>
        <div>Loading Profession Data...</div>
    </div>
