<?php
// sections/progression.php - PATCHED FOR PUBLIC VIEW (v2 - AJAX compatible)
...
// ============================================
?>
<section id="tab-progression" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
