<?php
// sections/social.php - Social Tracking & Group Analysis
...
if (defined('PUBLIC_VIEW')) {
    ...
    $charName = htmlspecialchars((string) ($character['name'] ?? ''), ENT_QUOTES, 'UTF-8');
    $userName = isset($_SESSION['username']) ? htmlspecialchars((string) $_SESSION['username'], ENT_QUOTES, 'UTF-8') : '';
}
// ============================================
// END PUBLIC VIEW SUPPORT
// ============================================
?>
<section id="tab-social" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
