<?php
// sections/travel-log.php - PATCHED FOR PUBLIC VIEW (v2 - AJAX compatible)
...
// ============================================
?>
<section id="tab-travel-log" class="tab-content" data-character-id="<?php echo (int) $character_id; ?>"
